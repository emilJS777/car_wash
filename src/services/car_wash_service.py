...
def create_car_wash(title, address, owner_id):
    ...
    car_wash = car_wash_service_db.create_car_wash(title=title, address=address, owner_id=owner_id)
...
def update_car_wash(car_wash_id, title, address, owner_id):
    ...
    car_wash = car_wash_service_db.update_car_wash(car_wash_id=car_wash_id, title=title,
