...
from src.services_db import auth_service_db, user_service_db, ticket_service_db, role_service_db
...
# GET AUTH USER
def get_profile():
    # GET TICKET ROLE AND USER FROM AUTH USER
    ...
    return response(True, {'user_name': user.name, 'role_name': role.title}, 200)
